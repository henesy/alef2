/*
 * Machine dependent power
 */

#include "/sys/src/cmd/qc/q.out.h"
#define AOUTL	".q"
...
enum
{
	Retireg		= 3,		/* Integer return */
	Regspass	= 3,		/* Complex ptr */
	Ireg		= 7,		/* Base integer registers */
	Maxireg		= 27,
	Retfreg		= Maxireg+1,
	Freg		= Retfreg,
	Maxfreg		= Retfreg+26,	/* BUG? */
	Retfregno	= 0,
	Retiregno	= 3,
	Nreg		= 55,
	RegSP		= 1,
...
#define	R0ISZERO	1	/* always true for power/Alef */
