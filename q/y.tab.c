...
#line	2	"/usr/seh/wrk/alef2/alef/port/parl.y"
#include <u.h>
#include <libc.h>
#include <bio.h>
#include "parl.h"
...
#line	10	"/usr/seh/wrk/alef2/alef/port/parl.y"
typedef union 
{
	Node	*node;
	Sym	*sym;
...
#line	1141	"/usr/seh/wrk/alef2/alef/port/parl.y"
...
case 1:
#line	69	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			polyasgn();
			packdepend();
			strop();
...
case 2:
#line	77	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 3:
#line	79	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 8:
#line	109	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			fungen(yypt[-0].yyv.node, yypt[-5].yyv.node);
			adtbfun = nil;
			yyval.node = yypt[-5].yyv.node->left;
...
case 9:
#line	115	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 10:
#line	121	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			if(yypt[-1].yyv.node)
				buildtype(yypt[-1].yyv.node);
		} break;
case 11:
#line	126	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			newtype(yypt[-3].yyv.type, yypt[-2].yyv.node, yypt[-1].yyv.node);
			yyval.node = nil;
		} break;
case 12:
#line	131	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 13:
#line	140	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 14:
#line	142	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = yypt[-1].yyv.node; } break;
case 16:
#line	147	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = nil; } break;
case 17:
#line	149	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = nil; } break;
case 18:
#line	151	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = nil; } break;
case 19:
#line	155	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-0].yyv.node->init = adtfunc(yypt[-2].yyv.ltype, yypt[-0].yyv.node);
			yyval.node = yypt[-0].yyv.node;
		} break;
case 20:
#line	160	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-0].yyv.node->init = adtfunc(yypt[-2].yyv.ltype, yypt[-0].yyv.node);
...
case 21:
#line	168	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			if(yypt[-0].yyv.node)
				yypt[-0].yyv.node->sym->lexval = Ttypename;
		} break;
case 22:
#line	173	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OAGDECL, an(OLIST, yypt[-5].yyv.node, yypt[-0].yyv.node), yypt[-2].yyv.node);
		} break;
case 23:
#line	177	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			if(yypt[-0].yyv.node)
				yypt[-0].yyv.node->sym->lexval = Ttypename; 
		} break;
case 24:
#line	182	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OUNDECL, an(OLIST, yypt[-5].yyv.node, yypt[-0].yyv.node), yypt[-2].yyv.node);
		} break;
case 25:
#line	186	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			if(yypt[-1].yyv.node) {
...
case 26:
#line	196	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			if(yypt[-6].yyv.node) {
...
case 27:
#line	207	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			setbase = 0;
			if(yypt[-0].yyv.node) {
				yypt[-0].yyv.node->sym->lexval = Ttypename;
...
case 28:
#line	215	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSETDECL, nil, nil);
		} break;
case 29:
#line	221	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 31:
#line	224	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONAME, nil, nil);
			yyval.node->sym = yypt[-0].yyv.ltype.s;
		} break;
case 32:
#line	231	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 33:
#line	233	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-1].yyv.node;
		} break;
case 34:
#line	239	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			polytyp(yypt[-0].yyv.node);
		} break;
case 35:
#line	243	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONAME, nil, nil);
...
case 36:
#line	256	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-2].yyv.node->left = yypt[-0].yyv.node;
			yyval.node = yypt[-2].yyv.node;
		} break;
case 38:
#line	264	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 39:
#line	270	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 40:
#line	272	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-0].yyv.node->sym->lexval = Tsname;
			coverset(yypt[-0].yyv.node);
		} break;
case 41:
#line	277	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 42:
#line	285	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONAME, nil, nil);
			yyval.node->sym = yypt[-0].yyv.sym;
		} break;
case 44:
#line	293	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 45:
#line	299	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 47:
#line	302	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 48:
#line	308	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 49:
#line	317	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 50:
#line	319	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-0].yyv.node;
		} break;
case 52:
#line	326	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OINDEX, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 53:
#line	330	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OINDEX, yypt[-0].yyv.node, nil);
			yyval.node->sym = yypt[-1].yyv.sym;
		} break;
case 54:
#line	335	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OILIST, yypt[-1].yyv.node, nil);
		} break;
case 55:
#line	339	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OINDEX, yypt[-4].yyv.node, an(OILIST, yypt[-1].yyv.node, nil));
		} break;
case 56:
#line	343	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 57:
#line	349	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONAME, yypt[-0].yyv.node, nil);
			yyval.node->sym = yypt[-1].yyv.sym;
		} break;
case 58:
#line	354	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONAME, yypt[-0].yyv.node, yypt[-2].yyv.node);
			yyval.node->sym = yypt[-1].yyv.sym;
		} break;
case 59:
#line	359	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 60:
#line	365	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 61:
#line	373	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 62:
#line	375	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 63:
#line	383	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OIND, nil, nil);
		} break;
case 64:
#line	387	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OIND, yypt[-1].yyv.node, nil);
		} break;
case 65:
#line	394	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPROTO, nil, nil);
			yyval.node->t = builtype[TVOID];
		} break;
case 67:
#line	400	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OADTARG, nil, nil);
			yyval.node->t = at(TIND, yypt[-0].yyv.type);
		} break;
case 68:
#line	405	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OADTARG, nil, nil);
			yyval.node->t = yypt[-0].yyv.type;
		} break;
case 69:
#line	410	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 70:
#line	416	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPROTO, nil, nil);
			yyval.node->t = yypt[-0].yyv.type;
		} break;
case 71:
#line	421	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = argproto(yypt[-2].yyv.type, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 72:
#line	425	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node= an(OPROTO, nil, nil);
...
case 73:
#line	433	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node= an(OPROTO, nil, nil);
...
case 74:
#line	441	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-0].yyv.node;
		} break;
case 75:
#line	445	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 76:
#line	454	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OVARARG, nil, nil);
		} break;
case 77:
#line	460	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPROTO, nil, nil);
			yyval.node->t = yypt[-0].yyv.type;
		} break;
case 78:
#line	465	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node= an(OPROTO, nil, nil);
			yyval.node->t = yypt[-6].yyv.type;
			yyval.node->t = at(TFUNC, yyval.node->t);
...
case 79:
#line	473	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			applytype(yypt[-1].yyv.type, yypt[-0].yyv.node);
			yyval.node = yypt[-0].yyv.node;
			if(yyval.node->t->type == TARRAY) {
...
case 80:
#line	484	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 81:
#line	486	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 82:
#line	492	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 83:
#line	498	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			applytype(yypt[-2].yyv.type, yypt[-1].yyv.node);
			pushdcl(yypt[-1].yyv.node, Automatic);
			yyval.node = yypt[-1].yyv.node;
...
case 84:
#line	506	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ enterblock(); } break;
case 85:
#line	508	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ scopeis(Automatic); } break;
case 86:
#line	510	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ leaveblock(); } break;
case 87:
#line	512	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = an(OBLOCK, yypt[-2].yyv.node, nil); } break;
case 88:
#line	514	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ enterblock(); } break;
case 89:
#line	516	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ scopeis(Automatic); } break;
case 90:
#line	518	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ leaveblock(); } break;
case 91:
#line	520	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = an(OLBLOCK, yypt[-2].yyv.node, nil); } break;
case 92:
#line	524	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 93:
#line	526	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 94:
#line	532	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-1].yyv.node;
		} break;
case 95:
#line	536	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLBLOCK, yypt[-1].yyv.node, nil);
		} break;
case 96:
#line	542	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 97:
#line	544	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 98:
#line	549	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ settype(yypt[-0].yyv.type); } break;
case 99:
#line	550	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			unsettype();
			yyval.node = an(OCASE, con(typesig(yypt[-3].yyv.type)), yypt[-0].yyv.node);
		} break;
case 100:
#line	555	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODEFAULT, nil, yypt[-0].yyv.node);
		} break;
case 101:
#line	561	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-1].yyv.node;
		} break;
case 102:
#line	565	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLBLOCK, yypt[-1].yyv.node, nil);
		} break;
case 103:
#line	571	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 104:
#line	573	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 105:
#line	579	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCASE, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 106:
#line	583	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODEFAULT, nil, yypt[-0].yyv.node);
		} break;
case 108:
#line	590	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLABEL, yypt[-0].yyv.node, nil);
			yyval.node->sym = yypt[-1].yyv.sym;
		} break;
case 109:
#line	597	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 110:
#line	599	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLABEL, nil, nil);
			yyval.node->sym = yypt[-0].yyv.sym;
		} break;
case 112:
#line	607	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, an(OLABEL, nil, nil), yypt[-0].yyv.node);
			yyval.node->left->sym = yypt[-2].yyv.sym;
		} break;
case 113:
#line	614	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 114:
#line	616	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = strnode(yypt[-0].yyv.string, 0);
		} break;
case 115:
#line	622	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 118:
#line	626	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCHECK, yypt[-2].yyv.node, yypt[-1].yyv.node);
		} break;
case 119:
#line	630	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OALLOC, yypt[-1].yyv.node, nil);
		} break;
case 120:
#line	634	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OUALLOC, yypt[-1].yyv.node, nil);
		} break;
case 121:
#line	638	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ORESCUE, yypt[-0].yyv.node, nil);
		} break;
case 122:
#line	642	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ORAISE, yypt[-1].yyv.node, nil);
		} break;
case 123:
#line	646	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OGOTO, nil, nil);
			yyval.node->sym = yypt[-1].yyv.sym;
		} break;
case 124:
#line	651	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPROCESS, yypt[-1].yyv.node, nil);
		} break;
case 125:
#line	655	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OTASK, yypt[-1].yyv.node, nil);
		} break;
case 126:
#line	659	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OBECOME, yypt[-1].yyv.node, nil);
		} break;
case 127:
#line	663	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSELECT, yypt[-0].yyv.node, nil);
		} break;
case 128:
#line	667	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ORET, yypt[-1].yyv.node, nil);
		} break;
case 129:
#line	671	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OFOR, an(OLIST, yypt[-6].yyv.node, an(OLIST, yypt[-4].yyv.node, yypt[-2].yyv.node)), yypt[-0].yyv.node);
		} break;
case 130:
#line	675	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OWHILE, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 131:
#line	679	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODWHILE, yypt[-1].yyv.node, yypt[-4].yyv.node);
		} break;
case 132:
#line	683	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OIF, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 133:
#line	687	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OIF, yypt[-4].yyv.node, an(OELSE, yypt[-2].yyv.node, yypt[-0].yyv.node));
		} break;
case 134:
#line	691	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPAR, yypt[-0].yyv.node, nil);
		} break;
case 135:
#line	695	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSWITCH, yypt[-1].yyv.node, yypt[-0].yyv.node);
		} break;
case 136:
#line	699	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-0].yyv.node->link = swstack;
			swstack = yypt[-0].yyv.node;
		} break;
case 137:
#line	704	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			swstack = yypt[-2].yyv.node->link;
			yyval.node = an(OSWITCH, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 138:
#line	709	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCONT, nil, nil);
			yyval.node->ival = yypt[-1].yyv.ival;
		} break;
case 139:
#line	714	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OBREAK, nil, nil);
			yyval.node->ival = yypt[-1].yyv.ival;
		} break;
case 140:
#line	721	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.ival = 1; } break;
case 142:
#line	726	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 145:
#line	732	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OMUL, yypt[-2].yyv.node, yypt[-0].yyv.node); 
		} break;
case 146:
#line	736	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODIV, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 147:
#line	740	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OMOD, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 148:
#line	744	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OADD, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 149:
#line	748	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSUB, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 150:
#line	752	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ORSH, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 151:
#line	756	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLSH, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 152:
#line	760	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLT, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 153:
#line	764	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OGT, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 154:
#line	768	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 155:
#line	772	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OGEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 156:
#line	776	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 157:
#line	780	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 158:
#line	784	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLAND, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 159:
#line	788	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OXOR, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 160:
#line	792	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLOR, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 161:
#line	796	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCAND, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 162:
#line	800	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCOR, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 163:
#line	804	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OASGN, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 164:
#line	808	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OVASGN, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 165:
#line	812	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OASGN, an(OSEND, yypt[-3].yyv.node, nil), yypt[-0].yyv.node);
		} break;
case 166:
#line	816	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OADDEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 167:
#line	820	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSUBEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 168:
#line	824	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OMULEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 169:
#line	828	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODIVEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 170:
#line	832	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OMODEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 171:
#line	836	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ORSHEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 172:
#line	840	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLSHEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 173:
#line	844	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OANDEQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 174:
#line	848	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OOREQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 175:
#line	852	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OXOREQ, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 176:
#line	856	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OITER, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 178:
#line	863	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCONV, yypt[-0].yyv.node, nil);
			yyval.node->t = yypt[-2].yyv.type;
		} break;
case 179:
#line	868	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OALLOC, yypt[-0].yyv.node, nil);
			yyval.node->t = yypt[-2].yyv.type;
		} break;
case 181:
#line	876	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.type = mkcast(yypt[-1].yyv.type, yypt[-0].yyv.node);
		} break;
case 182:
#line	880	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 183:
#line	887	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.type = yypt[-0].yyv.type;
		} break;
case 185:
#line	894	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OIND, yypt[-0].yyv.node, nil);
		} break;
case 186:
#line	898	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OADDR, yypt[-0].yyv.node, nil);
		} break;
case 187:
#line	902	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OADD, yypt[-0].yyv.node, con(0));
		} break;
case 188:
#line	906	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSUB, con(0), yypt[-0].yyv.node);
		} break;
case 189:
#line	910	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OEDEC, yypt[-0].yyv.node, nil);
		} break;
case 190:
#line	914	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OXEROX, yypt[-0].yyv.node, nil);
		} break;
case 191:
#line	918	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OEINC, yypt[-0].yyv.node, nil);
		} break;
case 192:
#line	922	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ONOT, yypt[-0].yyv.node, nil);
		} break;
case 193:
#line	926	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OXOR, yypt[-0].yyv.node, con(-1));
		} break;
case 194:
#line	930	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSTORAGE, yypt[-0].yyv.node, nil);
		} break;
case 195:
#line	934	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ORECV, yypt[-0].yyv.node, nil);
		} break;
case 196:
#line	938	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCRCV, yypt[-0].yyv.node, nil);
		} break;
case 197:
#line	943	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 200:
#line	948	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OILIST, yypt[-1].yyv.node, nil);
			yyval.node->t = at(TAGGREGATE, 0);
		} break;
case 202:
#line	956	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 203:
#line	961	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-1].yyv.node;
...
case 204:
#line	969	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OSTORAGE, nil, nil);
			yyval.node->t = yypt[-1].yyv.type;
		} break;
case 205:
#line	974	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCALL, yypt[-3].yyv.node, yypt[-1].yyv.node);
		} break;
case 206:
#line	978	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OIND, an(OADD, yypt[-3].yyv.node, yypt[-1].yyv.node), nil);
		} break;
case 207:
#line	982	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODOT, yypt[-2].yyv.node, nil);
			yyval.node->sym = yypt[-0].yyv.sym;
		} break;
case 208:
#line	987	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 209:
#line	999	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(ODOT, an(OIND, yypt[-2].yyv.node, nil), nil);
			yyval.node->sym = yypt[-0].yyv.sym;
		} break;
case 210:
#line	1004	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPDEC, yypt[-1].yyv.node, nil);
		} break;
case 211:
#line	1008	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OPINC, yypt[-1].yyv.node, nil);
		} break;
case 212:
#line	1012	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCSND, yypt[-1].yyv.node, nil);
		} break;
case 213:
#line	1016	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			derivetype(yypt[-0].yyv.node);
		} break;
case 214:
#line	1020	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = vargptr();
		} break;
case 215:
#line	1024	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = con(yypt[-0].yyv.ival);
		} break;
case 216:
#line	1028	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = con(0);
			yyval.node->t = at(TIND, builtype[TVOID]);
		} break;
case 217:
#line	1033	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = con(yypt[-0].yyv.ival);
		} break;
case 218:
#line	1037	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OCONST, nil, nil);
...
case 219:
#line	1043	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = strnode(yypt[-0].yyv.string, 0);
		} break;
case 220:
#line	1047	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = strnode(yypt[-0].yyv.string, 1);
		} break;
case 222:
#line	1054	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.sym = yypt[-0].yyv.ltype.s;
		} break;
case 223:
#line	1060	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 226:
#line	1066	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = an(OLIST, yypt[-2].yyv.node, yypt[-0].yyv.node);
		} break;
case 228:
#line	1073	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-2].yyv.type->member = yypt[-0].yyv.type;
			yyval.type = yypt[-2].yyv.type;
		} break;
case 229:
#line	1080	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-0].yyv.type->class = yypt[-1].yyv.clas;
			yyval.type = yypt[-0].yyv.type;
		} break;
case 230:
#line	1085	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.type = unshape(yypt[-1].yyv.type);
			yyval.type->class = yypt[-4].yyv.clas;
		} break;
case 231:
#line	1090	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.type = unshape(yypt[-1].yyv.type);
			yyval.type->class = yypt[-3].yyv.clas;
		} break;
case 233:
#line	1098	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yypt[-2].yyv.type->variant = yypt[-0].yyv.type;
			yyval.type = yypt[-2].yyv.type;
		} break;
case 234:
#line	1104	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TINT, 0); } break;
case 235:
#line	1105	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TUINT, 0); } break;
case 236:
#line	1106	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TSINT, 0); } break;
case 237:
#line	1107	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TSUINT, 0); } break;
case 238:
#line	1108	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TCHAR, 0); } break;
case 239:
#line	1109	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TFLOAT, 0); } break;
case 240:
#line	1110	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = at(TVOID, 0); } break;
case 241:
#line	1112	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = yypt[-0].yyv.ltype.t; } break;
case 242:
#line	1114	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.type = polybuild(yypt[-3].yyv.ltype.t, yypt[-1].yyv.type); } break;
case 243:
#line	1116	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
...
case 244:
#line	1124	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.node = nil; } break;
case 245:
#line	1126	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.node = yypt[-1].yyv.node;
		} break;
case 246:
#line	1132	"/usr/seh/wrk/alef2/alef/port/parl.y"
{
			yyval.clas = Global;
			if(buildadt)
				yyval.clas = Adtdeflt;
...
case 247:
#line	1137	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.clas = External; } break;
case 248:
#line	1138	"/usr/seh/wrk/alef2/alef/port/parl.y"
{ yyval.clas = Internal; } break;
case 249:
#line	1139	"/usr/seh/wrk/alef2/alef/port/parl.y"
